...
async function main() {
    ...
    const p2 = await prisma.product.create({
        data: {
            ...
            recipe: {
                create: [
                    { materialId: materials[1].id, quantity: 2.5 },
                    { materialId: materials[2].id, quantity: 2 },
                    { materialId: materials[5].id, quantity: 2 },
                    { materialId: materials[3].id, quantity: 1 },
                    { materialId: materials[4].id, quantity: 1 },
    ...
    const p3 = await prisma.product.create({
        data: {
            ...
            recipe: {
                create: [
                    { materialId: materials[0].id, quantity: 2 },
                    { materialId: materials[5].id, quantity: 2.5 },
                    { materialId: materials[6].id, quantity: 0.5 },
                    { materialId: materials[7].id, quantity: 3 },
                ]
            }
        },
